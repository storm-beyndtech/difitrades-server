...
async function welcomeMail(userEmail) {
	try {
      ...
      <head>
        ...
        <title>Welcome to Difitrades</title>
      </head>
              ...
              <table>
                <tr>
                  <td style="background-color: #114000 !important; padding: 20px; text-align: center;">
                    <img style="max-width: 150px;" src="https://res.cloudinary.com/ddb1vjioq/image/upload/v1748154351/difilogo_nctnls.png" alt="Difitrades Logo">
                  </td>
                </tr>
                ...
                <tr>
                  <td style="background-color: #ffffff; padding: 40px 20px;">
                    ...
                    <p style="margin-bottom: 20px;">We're thrilled to have you as part of our community. At Difitrades, we are dedicated to providing the best services and support to our customers.</p>
                    <p style="margin-bottom: 20px;">If you have any questions or need assistance, feel free to reach out to our support team at support@difitrades.com.</p>
                    <p style="margin-bottom: 20px;">Best regards,</p>
                    <p style="margin-bottom: 20px;">The Difitrades Team</p>
                  </td>
                </tr>
      
                <tr>
                  <td style="background-color: #114000 !important; padding: 20px; text-align: center;">
                    <img style="max-width: 100px; margin-bottom: 10px;" src="https://res.cloudinary.com/ddb1vjioq/image/upload/v1748154351/difilogo_nctnls.png" alt="Difitrades Logo">
                    <p style="font-size: 12px; color: #fafafa !important; margin-bottom: 10px;">© 2024 Difitrades Company | All Rights Reserved</p>
                  </td>
                </tr>
              ...
              <table>
                ...
                <tr>
                  <td style="background-color: #ffffff; padding: 40px 20px;">
                    ...
                    <a style="max-width: 200px; padding: 15px 30px; border-radius: 30px; background-color: #114000 !important; color: #fafafa !important; text-decoration: none;" href="https://www.difitrades.com/password-reset/newPassword">Reset Password</a>
                    <p style="margin: 20px 0;">If you have any questions or need assistance, feel free to reach out to our support team at support@difitrades.com</p>
                    <p style="margin-bottom: 20px;">Best regards,</p>
                    <p style="margin-bottom: 20px;">The Difitrades Team</p>
                  </td>
                </tr>
              ...
              <table>
                ...
                <tr>
                  <td style="background-color: #ffffff; padding: 40px 20px;">
                    ...
                    <p style="margin-bottom: 20px;">Your deposit of <strong>${amount}</strong>, ${date}, was successful! Your can now use your funds to trade on Difitrades.</p>
                    <p style="margin-bottom: 20px;">If you have any questions or need assistance, feel free to reach out to our support team at support@difitrades.com</p>
                    <p style="margin-bottom: 20px;">Best regards,</p>
                    <p style="margin-bottom: 20px;">The Difitrades Team</p>
                  </td>
            ...
            <td>
              <table>
                ...
                <tr>
                  <td style="background-color: #ffffff; padding: 40px 20px;">
                    <p style="margin-bottom: 20px;">Dear ${fullName}</p>
                    <p style="margin-bottom: 20px;">Your Withdrawal of <strong>${amount}</strong>, ${date}, was successful! Thanks for choosing Difitrades!</p>
                    <p style="margin-bottom: 20px;">If you have any questions or need assistance, feel free to reach out to our support team at support@difitrades.com</p>
                    <p style="margin-bottom: 20px;">Best regards,</p>
                    <p style="margin-bottom: 20px;">The Difitrades Team</p>
                  </td>
